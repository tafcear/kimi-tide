...
| **分工层**（0.2.x 路由器已接线 → 0.3.0 能力评分 → 0.5.0 规则驱动，main 已实施未发布） | 预设/规则路由、能力缺口补偿；0.5.0 起为命名预设（省钱/能力/可自建）+ 有序规则（带图/关键词组）+ 全量候选池枚举（2026-08-21，分支 `feat/0.5.0-rule-driven-routing`） | **短期内被替代的概率低**，但非绝对——官方/社区可能推出通用路由选择器；需持续跟踪机制演进 | **长期投入**：项目当前的核心价值 |
